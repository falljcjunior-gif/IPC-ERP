              ...
              <motion.div key={emp.id} variants={item} whileHover={{ y: -4 }} className="glass"
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.25rem' }}>
                  <div style={{ position: 'relative' }}>
                    ...
                    <div style={{ position: 'absolute', bottom: '-3px', right: '-3px', width: '18px', height: '18px', borderRadius: '6px', background: emp.active !== false ? '#10B981' : '#94A3B8', border: '3px solid var(--bg)' }} />
                  </div>
