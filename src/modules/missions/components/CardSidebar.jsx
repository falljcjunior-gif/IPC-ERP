          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', marginBottom: '0.5rem' }}>
              ...
              <div style={{ display: 'flex', gap: '0.4rem' }}>
                ...
                <button onClick={() => setAdding(false)} aria-label="Annuler" style={{ padding: '0.4rem 0.6rem', borderRadius: '0.4rem', background: '#F1F5F9', border: 'none', color: '#64748B', cursor: 'pointer', fontSize: '0.78rem' }}>✕</button>
              </div>
            </div>
          </motion.div>
        )}
