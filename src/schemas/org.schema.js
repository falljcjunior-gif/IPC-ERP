...
export const GROUP_ENTITIES = [
  // Level 1 — Holding (root entity — never removed)
  {
    id:           'ipc_holding',
  ...
  // Subsidiaries and Foundation are provisioned via the Entity Wizard
  // and will appear here once created via EntityService (Firestore).
];
