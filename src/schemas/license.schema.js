...
export const ALL_MODULES = [
  ...
  { id: 'timesheets',  label: 'Temps & Présences',      category: 'RH',         icon: '⏱️' },
  // Projects
  ...
  { id: 'signature',   label: 'Signature Électronique', category: 'Collab.',    icon: '✍️' },
  { id: 'helpdesk',    label: 'Helpdesk & Support',     category: 'Collab.',    icon: '🎫' },
  // Compliance
  { id: 'legal',       label: 'Juridique',              category: 'Conformité', icon: '⚖️' },
...
export const ENTITY_STATE_META = {
  [ENTITY_STATES.PROVISIONING]: { color: '#3498db', label: 'Provisioning', icon: '⚙️' },
  [ENTITY_STATES.ACTIVE]:       { color: '#2ecc71', label: 'Actif',        icon: '✅' },
  [ENTITY_STATES.TRIAL]:        { color: '#f39c12', label: 'Essai',        icon: '🔑' },
  [ENTITY_STATES.SUSPENDED]:    { color: '#e74c3c', label: 'Suspendu',     icon: '⏸️' },
  [ENTITY_STATES.ARCHIVED]:     { color: '#6b7280', label: 'Archivé',      icon: '📦' },
  [ENTITY_STATES.DELETED]:      { color: '#374151', label: 'Supprimé',     icon: '🗑️' },
